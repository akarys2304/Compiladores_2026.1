...
public class JanderLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ALGORITMO", "DECLARE", "LEIA", "ESCREVA", "FIM_ALGORITMO", "SE", "ENTAO", 
			"SENAO", "FIM_SE", "PARA", "FIM_PARA", "ENQUANTO", "FIM_ENQUANTO", "FACA", 
			"ATE", "RETORNE", "INTEIRO", "REAL", "LITERAL", "LOGICO", "VERDADEIRO", 
			"FALSO", "OP_ARIT_SOMA", "OP_ARIT_MULT", "OP_RELAC", "OP_BOOL_E", "OP_BOOL_OU", 
			"OP_BOOL_NAO", "ATRIB", "DELIM", "VIRGULA", "ABREPAR", "FECHAPAR", "PONTO", 
			"IDENT", "NUM_REAL", "NUM_INT", "CADEIA", "ESC_SEQ", "WS", "COMENTARIO", 
			"CADEIA_NAO_FECHADA", "INVALIDO"
		};
	}
	...
	public JanderLexer(CharStream input) {
		super(input);
